...
BOOL_OPT opt_lcve_fast("lcvefast", "enable fast elections using Luby MIS (nondeterministic)", true);
...
INT_OPT opt_mdm_delay("mdmdelay", "delay MDM search rounds a number of conflicts", 0, INT32R(0, INT32_MAX));
