...
struct FORMULA {
  ...
  int maxClauseSize;
  FORMULA() : path(), c2v(0), size(0), units(0), large(0), binaries(0), ternaries(0), maxClauseSize(0) {}
  FORMULA(const string& path) : path(path), c2v(0), size(0), units(0), large(0), binaries(0), ternaries(0), maxClauseSize(0) {}
