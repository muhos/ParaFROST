...
struct WATCH {
  ...
  inline WATCH(const C_REF& cref, const int& _size, const uint32& _imp) : ref(cref), imp(_imp), size(_size) {}
...
struct DWATCH {
  ...
  inline DWATCH(const uint32 _lit, const uint32 _imp, const C_REF _ref, const int& _size) : ref(_ref), lit(_lit), imp(_imp), size(_size) {}
};
